    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Découvrez la richesse du patrimoine africain à travers nos différentes collections.',
            style: TextStyle(
  ...
  Widget _buildCategoriesGrid(BuildContext context) {
    final categories = [
      CategoryData(
        ...
        description: 'Histoires traditionnelles et contes populaires',
      ...
      CategoryData(
        ...
        description: 'Héros, leaders et figures emblématiques',
        icon: Icons.person_outline,
        color: AppColors.secondary,
        itemCount: '15+ personnages',
      ),
      CategoryData(
        id: 'festivals',
        title: 'Festivals & Traditions',
        description: 'Célébrations et traditions culturelles',
        icon: Icons.festival,
      ...
      CategoryData(
        ...
        description: 'Empires et royaumes historiques',
        icon: Icons.account_balance,
        color: AppColors.primary,
        itemCount: '12+ royaumes',
      ),
      CategoryData(
        id: 'music',
        title: 'Musique Africaine',
        description: 'Instruments, rythmes et genres musicaux',
        icon: Icons.music_note,
        color: AppColors.secondary,
        itemCount: '30+ morceaux',
      ),
      CategoryData(
        id: 'art',
        title: 'Art & Culture',
        description: 'Œuvres d\'art et expressions culturelles',
        icon: Icons.palette,
        color: AppColors.accent,
        itemCount: '40+ œuvres',
      ),
